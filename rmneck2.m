function [neck,l,r,f,b] = rmneck2(a1,a2)
...
% plot(ps(2,1),ps(2,2), 'g*');
% plot(ps(1,1),ps(1,2), 'g*');

% plot(X2(head),Y2(head), 'g*');
% plot(X2(base),Y2(base), 'r*');
% plot(X2(st),Y2(st), 'g*');
% % plot(X2(base:base2),Y2(base:base2), 'm*');
