function [] = model1()
    ...
    file = 'f_mh1.png';
    file2 = 's_mh1.png';
    height = 173.04; %in cms
    height=rounds2(height);
    
    Mh_mus = 100; % input in percentage
    Mh_wt = 127.60; %input in percentage
    prop_units = 8;  %input in units after manual calculation
    chest_factor = 0.98; 
