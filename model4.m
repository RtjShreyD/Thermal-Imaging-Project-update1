function [] = model4()
    ...
    file = 'f_mh4.png';
    file2 = 's_mh4.png';
    height = 172.64; %in cms
    height=rounds2(height);
    
    Mh_mus = 58.50; % input in percentage
    Mh_wt = 108.50; %input in percentage
    prop_units = 7.2;  %input in units after manual calculation
    chest_factor = 0.98; 
