function [] = model2()
    ...
    file = 'f_mh2.png';
    file2 = 's_mh2.png';
    height = 179.70; %in cms
    height=rounds2(height);
    
    Mh_mus = 100; % input in percentage
    Mh_wt = 125.40; %input in percentage
    prop_units = 12;  %input in units after manual calculation
    chest_factor = 0.98; 
