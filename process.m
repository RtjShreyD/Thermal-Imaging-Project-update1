function []= process(filename1,filename2,filename3,filename4,height,th,clm)   %%This is demonstration function now we use every person as a different function refer to Arshad.m
if count<26
    Stringvect = ('B':'Z');
...
% kk=7; 
%height=67;
%filename1='hemanthf1.csv';  %%give here any filename
%filename2='hemanths1.csv';
%filename3='hemanthf2.csv';
%filename4='hemanths2.csv'; 
...
try
    ...
    ps(1,1,2)=pneck(1,2);
    ps(1,2,1)=pneck(2,1);
    ps(1,2,2)=pneck(2,2);n1 = realneck2(filename1,filename2,height,kk);
...
Values = rounds(ValuesInInches);
 ...
 xlswrite(excelfile,Values,'Hemanth',posColumn);
