function [] = model5()
    ...
    file = 'f_mh5.png';
    file2 = 's_mh5.png';
    height = 171.33; %in cms
    height=rounds2(height);
   
    Mh_mus = 1; % input in percentage
    Mh_wt = 150; %input in percentage
    prop_units = 4.2;  %input in units after manual calculation
    chest_factor = 0.98; 
